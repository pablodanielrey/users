...
app.controller("CambioClaveTempCtrl", ["$scope", "$resource", "$timeout", '$state', '$stateParams', 'sessionService', function ($scope, $resource, $timeout, $state, $stateParams, sessionService) {
